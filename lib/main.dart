import 'package:demo_app/data/api_provider.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Movies App', style: TextStyle(
                  color: Colors.yellow,
                ),
        ),
            ...
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return moviesItem(
                  ...
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => MovieDetail(movie: snapshot.data.results[index],)));
                  }
                );
              },
            );
